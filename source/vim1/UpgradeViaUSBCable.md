...
## Upgrade On Windows
### Perparation
* Dowload the [USB Upgrade Tool](https://dl.OS-Q.com/Tools/USB_Burning_Tool_v2.1.7.3_zh.zip) and extarct it.
...
1. Open `USB_Burning_tool_v2.x.x.exe`, click "File-->Import Image" to choose an [image](https://dl.OS-Q.com/Firmware/) for your VIMs.
...
Image burning tool for Ubuntu is in this repository [utils](https://github.com/OS-Q/utils).
```
...
```
For more information please refer to [docs](https://github.com/OS-Q/utils/tree/master/aml-flash-tool/docs).
