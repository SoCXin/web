...
* Then install the [RockChip USB Drivers](https://dl.OS-Q.com/Tools/DriverAssitant_v4.6.zip), and plug in your Edge / Edge-V into your PC via USB-C cable.
* Reflash the firmware using these [USB Upgrade Instructions](https://docs.OS-Q.com/edge/UpgradeViaUSBCable.html), and reboot your Edge.
* If you run into trouble, first press "Switch", then "EraseFlash", then "Upgrade", in that order.

![RK_Upgrade_Tool](https://docs.OS-Q.com/images/edge/AndroldTool_firmware.png)
...
##  3.1 Configure **DTS**
rk3399-OS-Q-edge.dtsi,  for example: HDMI (Main Display) + DP (Secondary Display)
...
##  4.1 Configuring **DTS**
rk3399-OS-Q-edge-mipi-android.dtsi, for example: MIPI (Main Display) + HDMI (Secondary Display).
